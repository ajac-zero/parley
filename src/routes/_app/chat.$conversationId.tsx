  ...
  return (
    <main className="relative flex h-full min-w-0 flex-1 flex-col">
      <div className="relative flex min-h-0 flex-1 flex-col">
         ...
         * header itself is solid (so its own text stays crisp instead of
         * fading), with a short gradient strip right underneath it so
         * messages fade out over ~24px just before reaching it, rather
         * than vanishing abruptly. The header's height is fixed (see
         * `HEADER_INSET` in thread.tsx), so unlike the composer it doesn't
         * need to be measured. */}
